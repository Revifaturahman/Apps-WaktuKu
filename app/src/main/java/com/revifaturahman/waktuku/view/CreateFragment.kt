...
import com.revifaturahman.waktuku.databinding.FragmentCreateBinding
import com.revifaturahman.waktuku.utils.AlarmHelper
...
class CreateFragment : Fragment() {
    ...
    private fun startRecording() {
        ...
        binding.btnRecordVoice.setImageResource(R.drawable.ic_stop) // ikon stop rekam
        binding.btnDeleteRecording.visibility = View.GONE // sembunyikan tombol hapus saat rekam
    }
    ...
    private fun stopRecording() {
        ...
        binding.btnRecordVoice.setImageResource(R.drawable.ic_mic) // kembali ke ikon mic
        binding.btnDeleteRecording.visibility = View.VISIBLE // tampilkan tombol hapus
    }
    ...
    private fun deleteRecording() {
        ...
        audioPath = null
        binding.tvRecordingStatus.text = "Belum ada rekaman"
        binding.btnRecordVoice.setImageResource(R.drawable.ic_mic)
